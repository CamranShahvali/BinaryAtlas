...
TEST_CASE(
    "Heuristic detector scores virtual dispatch, jump tables, engine strings, and vtable regions")
{
  ...
  BinaryImage image(metadata, "synthetic", std::move(bytes), sections, {}, {}, {}, {}, {},
  ...
  function.referenced_strings = {"DirectX Present hook candidate", "UnityPlayer subsystem",
  ...
  function.blocks = {
      {0x1000,
       0x1008,
       {0x1000},
       {{0x1000, std::nullopt, BlockEdgeType::unresolved_indirect, false}},
       false},
  };
